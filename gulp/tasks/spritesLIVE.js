...
gulp.task('spriteClean', function() {
	return del(['./site/temp/sprites', './site/dev/source/images/sprites'])
});


gulp.task('createSpriteSVG', ['spriteClean'], function() {
	return gulp.src('./site/dev/source/images/svgs/**/*.svg')
...
gulp.task('copySprites', ['createPNGcopy'], function() {
	return gulp.src('./site/temp/sprites/css/**/*.{svg,png}')
		.pipe(gulp.dest('./site/dev/source/images/sprites'));
});
...
gulp.task('copySpriteCSS', ['createSpriteSVG'], function() {
	return gulp.src('./site/temp/sprites/css/*.css')
		...
		.pipe(gulp.dest('./site/dev/source/styles/main'));
});
...
gulp.task('createIcons', 
	['spriteClean', 'createSpriteSVG', 'createPNGcopy', 'copySprites', 
	 'copySpriteCSS', 'endSpriteClean', 'createFavicons']);
